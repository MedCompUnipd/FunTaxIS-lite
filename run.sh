...
case "${type}" in
    ...
    "automatic"|"a"|"auto" )
                         ...
                         "${src_folder}"./purgeRootsInterproFormGaf.py -gaf "${goa_folder}${used_goa}" -gafout "${int_file_folder}goa_uniprot_all.gaf";
                         ...
                         "${src_folder}"./clusterTaxon.py -constraints "${tax_constr_def_file}" -species "${int_file_folder}speciesGOusage.txt" \
                         ...
                         -cumul "${int_file_folder}freqCumul_cluster_speciesGOusage.txt" -out "${int_file_folder}freqCumul_cluster_speciesGOusage_NEVER_IN.txt" ;
